...
async def play(_, message: Message):
    ...
    lel = await message.reply("**🔎 ᴅʜᴜɴᴅʀɪ ʜᴜ ʀᴜᴋ ...**")
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                try:
                    ...
                    await lel.edit(
                        "**🥀 ᴀᴅᴍɪɴ ʙᴀɴᴀ ᴄʜᴀʟ ғɪʀ ʜɪ ɢᴀɴᴀ ʙᴀᴊᴀᴜɴɢɪ 😎 ...**")
                    return

                try:
                    await USER.join_chat(invitelink)
                    await USER.send_message(
                        message.chat.id, "**😍ᴍᴀɪ ᴛᴀʏᴀʀ ʜᴜ sᴏɴɢ ʙᴀᴊᴀɴᴇ 😍 ...**")
    ...
    if audio:
        if round(audio.duration / 60) > DURATION_LIMIT:
            raise DurationLimitError(
                f"**🤣ᴀʙᴇ ᴋᴍ ᴛɪᴍᴇ ᴠᴀʟᴀ sᴏɴɢ ʟɢᴀ 💿 ʟᴇss ⚡️\n🤟 ᴛʜᴀɴ⚡️ {DURATION_LIMIT} 💞 ᴍɪɴ ...**"
            )

        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://te.legra.ph/file/16f9d4dde576ded7cea3a.png"
        ...
        if len(message.command) < 2:
            return await lel.edit(
                "**🤣 ɢɪᴠᴇ 🤣 ᴍᴜsɪᴄ 💿 ɴᴀᴍᴇ ᴋʏᴀ ɢᴜɴᴅᴀ ʙɴᴀᴇɢᴀ ᴛᴜ ʜᴛᴛ 😍\n💞 ᴛᴏ 🔊 ᴘʟᴀʏ 🌷...**"
            )
        await lel.edit("**🔄 ᴘʟᴀʏɪɴɢ ...**")
        ...
        try:
            ...
            await lel.edit(
                "**🔊 ᴋᴀɪsᴀ 😕 sᴏɴɢ 📵 ʟɢᴀʏᴀ ᴍɪʟᴀ ʜɪ ɴᴀʜɪ ❗️\n💞 ᴅᴜsʀᴀ ♨️ ʟɢᴀ 🌷...**"
            )
            print(str(e))
            return
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await message.reply_photo(
            photo="final.png",
            caption="**❤︎ sʜɪᴢᴜᴋᴀ❤︎ᴀᴅᴅᴇᴅ 💿 sᴏɴɢ❗️\n🔊 Ʌʈ 💞 ᴘᴏsɪᴛɪᴏɴ » `{}` 🌷 ...**".format(position),
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="**☺︎︎ sʜɪᴢᴜᴋᴀ♥︎ ᴍᴜsɪᴄ 🎸 ɴᴏᴡ 💞\n🔊 ᴘʟᴀʏɪɴɢ 😍 ᴏᴘ 🥀 ...**".format(),
           )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**💥 sʜɪᴢᴜᴋᴀ 💞 ɴᴏᴛʜɪɴɢ 🔇\n🚫 ᴘʟᴀʏɪɴɢ 🌷 ...**")
    else:
